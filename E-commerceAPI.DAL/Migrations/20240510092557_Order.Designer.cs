...
namespace E_commerceAPI.DAL.Migrations
{
    ...
    [Migration("20240510092557_Order")]
    partial class Order
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_commerceAPI.DAL.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_commerceAPI.DAL.Data.Models.OrderProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_commerceAPI.DAL.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("CreationOrderDate")
            ...
            modelBuilder.Entity("E_commerceAPI.DAL.Cart", b =>
                {
                    b.HasOne("E_commerceAPI.DAL.Product", "Product")
                        .WithMany("Carts")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("E_commerceAPI.DAL.User", "User")
                        .WithMany("Carts")
            ...
            modelBuilder.Entity("E_commerceAPI.DAL.Data.Models.OrderProduct", b =>
                {
                    b.HasOne("E_commerceAPI.DAL.Order", "Order")
